//copied from
//https://github.com/graphile/graphile-engine/blob/master/packages/graphile-build-pg/src/plugins/introspectionQuery.ts
...
console.log(makeIntrospectionQuery(99999999, { pgIgnoreRBAC: false, pgLegacyFunctionsOnly: false }));
